...
export default createSchema((p) => ({
  DomainEvent: p.createTable({
    ...
    domainId: p.hex().references("Domain.id"),
  ...
  NewOwner: p.createTable({
    id: p.string(),
    parentDomainId: p.hex().references("Domain.id"),
  ...
  Resolver: p.createTable({
    ...
    domainId: p.hex().references("Domain.id"),
    domain: p.one("domainId"),
    addrId: p.hex().references("Account.id"),
    addr: p.one("addrId"),
  ...
  Registration: p.createTable({
    ...
    registrantId: p.hex().references("Account.id"),
  ...
  NameTransferred: p.createTable({
    ...
    registrationEventId: p.string().references("RegistrationEvent.id"),
    registrationEvent: p.one("registrationEventId"),
    newOwnerId: p.hex().references("Account.id"),
  ...
  Domain: p.createTable({
    ...
    parentId: p.hex().references("Domain.id").optional(),
    parent: p.one("parentId"),
    subdomains: p.many("Domain.parentId"),
    subdomainCount: p.int(),
    resolvedAddressId: p.hex().references("Account.id").optional(),
    ...
    registrantId: p.hex().references("Account.id").optional(),
    registrant: p.one("registrantId"),

    wrappedOwnerId: p.hex().references("Account.id").optional(),
